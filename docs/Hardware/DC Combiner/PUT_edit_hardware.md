...
```json
{
  ...
  "driverNotes": "If values are high, write 1 to Data Format register under system tab.\n\nBentek use all Tamura Hall Effect Current Sensors L03S***D15 Series.\n\nFor 400A CT (L03S400D15) -> Scale = 0.1\n\nFor 200A CT (L03S200D15) -> Scale = 0.05",
  "driverRegisters": [],
  "eGauge": null,
  "fixedEnergyOffset": 0,
  "functionCode": 6,
  ...
  "outOfService": false,
  "outOfServiceNote": "",
  "outOfServiceUntil": "2025-12-23T00:49:00.4453748Z",
  "outputAllowed": [
    1,
    28
  ],
...
```json
{
  ...
  "outOfService": false,
  "outOfServiceNote": "",
  "outOfServiceUntil": "2025-12-23T00:49:08.2259982Z",
  "outputAllowed": [
    1,
    28
  ],
