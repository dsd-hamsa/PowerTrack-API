...
```http
GET /api/edit/hardware/gateway/info/H563252
...
```json
{
  ...
  "functionId": "GW0",
  "gateway": {
    "commandAccessLevel": 0,
    "connectionType": 2,
    "deviceGatewayType": 7,
    "dns1": "8.8.8.8",
    "dns2": "8.8.4.4",
    "firmware": {
      "client": "maki.exe;1.16.3.8|protobuf-net.dll;2.0.0.668\rModel:, Version:, Build:, ExtIP:172.24.96.118\rModel:, Version:, Build:, ExtIP:172.24.96.118",
      "debug": false,
      "enable": true,
      ...
      "ip1": "192.168.13.151",
      "ip2": "",
      "lastBoot": "211 d 22:35 (h:m)",
      "lastUpdate": "210 d 22:13 (h:m)",
      "server": "maki.exe;1.16.3.8|protobuf-net.dll;2.0.0.668"
    },
  ...
  "outOfService": false,
  "outOfServiceNote": "",
  "outOfServiceUntil": "2025-12-31T19:25:27.4473023Z",
  "outputAllowed": [],
  "outputKey": "",
  "parentKey": "S71191",
  "port": 0,
  ...
  "tags": {
    "attributes": [],
    "key": "{\"ancestorKey\":\"H563252\",\"isRecursive\":false,\"types\":[\"attribute\",\"keyword\",\"note\"]}",
    "keywords": [],
    "lastChanged": null,
    "notes": [],
    "powerDisplays": []
