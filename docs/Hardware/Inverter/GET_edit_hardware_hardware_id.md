...
```http
GET /api/edit/hardware/H492482
Accept: application/json
ae_s: *WPOMs1+UDquA3lmqjIlKm9mGjr7uixpBspy0HA==
ae_v: 05fc89
referer: https://apps.alsoenergy.com/powertrack/H492482/analysis/chartbuilder
```
...
```json
{
  ...
  "defaultChart": 2,
  "description": "Inv 1A (50 kW) SMA STP Core 1",
  "deviceRegisters": [
    {
      "dataName": "KwhAC",
      "dataNameDetail": null,
  ...
  "outOfService": false,
  "outOfServiceNote": "",
  "outOfServiceUntil": "2026-04-17T19:11:54.3997768Z",
  "outputAllowed": [
    2
  ],
  "outputKey": "H492480",
  ...
  "siteDcShare": 853.7600000000001,
  "siteHasInverterGroups": false,
  "sort": 11,
  "syncToLocus": false,
  "tags": {
    "attributes": [],
    "key": "{\"ancestorKey\":\"H492482\",\"isRecursive\":false,\"types\":[\"attribute\",\"keyword\",\"note\"]}",
    "keywords": [],
    "lastChanged": null,
    "notes": [],
    "powerDisplays": []
  ...
  "virtualWeather": null,
  "weather": null,
  "weatherStationKey1": "H492495",
  "weatherStationKey2": "H492495",
  "zone": null
}
```
